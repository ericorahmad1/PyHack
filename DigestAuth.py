...
for user in users:
    ...
    for passwd in passwords:
        ...
        if res.status_code == 401:
            print
            'Header from the server ' + res.headers['www-authenticate']
            ...
            headersDigest = {
                'Authorization': ' Digest username="' + user + '", realm="' + digestRealm + '", nonce="' + nonce + '", uri="' + URI + '", response="' + response + '", algorithm=MD5, qop=' + qop + ', nc=' + nc + ', cnonce="' + cnonce + '"'}
